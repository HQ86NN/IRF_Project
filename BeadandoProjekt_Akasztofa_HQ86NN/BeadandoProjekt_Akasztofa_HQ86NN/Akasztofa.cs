...
namespace BeadandoProjekt_Akasztofa_HQ86NN
{
    class Akasztofa
    {
        ...
        {
            g.DrawLine(toll, 750, 350, 800, 400);
        }

        private void Ballab(Graphics g)
        {
            g.DrawLine(toll, 700, 400, 750, 350);
        }
        ...
        {
            g.DrawLine(toll, 750, 190, 750, 350);
        }
        ...
        {
            g.DrawLine(toll, 600, 100, 600, 500); //kezdőpont.x/y végpont.x/y
        }
